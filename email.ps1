...
function send_email
{
	$From = "steven.dncltechzone@gmail.com"	
	$To = "DNCLTECHZONE@gmail.com"
	#$Cc = ""
	$Subject = ("ARRIVED FROM " + $Input1.Text + ", INVOICE #: " + $Input2.Text + ", S/N: " + $Input6.Text).ToUpper()
	$SMTPServer = "smtp.gmail.com"
	$SMTPPort = "587"
	# Create Credential Object
	$username = "steven.dncltechzone@gmail.com"	
	$secureStringPwd = ConvertTo-SecureString -String "yfqtfpqjjlttcytc" -AsPlainText -Force
